...
# scp copy to target
ssh $target_user@$target_ip "powershell -Command \"New-Item -ItemType Directory -Path '$target_dir' -Force;\""
...
#ps_command+="npm install --no-save;"
#ps_command+="appium driver install --source=local \"$target_dir\";"

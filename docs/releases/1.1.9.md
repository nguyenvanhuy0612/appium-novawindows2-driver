# Release 1.1.9 — Upstream-sync batch (Detailed Notes)
...
> **Note:** these notes document the upstream-sync half of the published `1.1.9` release. The full `1.1.9` change set in [`CHANGELOG.md`](../../CHANGELOG.md) also includes a code-review-driven hardening batch (PowerShell auto-restart, security fixes, consistency fixes, scripts + docs reorganisation).
...
Synchronised relevant changes from [`AutomateThePlanet/appium-novawindows-driver`](https://github.com/AutomateThePlanet/appium-novawindows-driver) versions 1.3.0 → 1.4.0. Details in [`../project-overview.md` §10](../project-overview.md#10-applied-upstream-merges-2026-04-23). Briefly:
...
- [`../project-overview.md`](../project-overview.md) — purpose, feature overview, upstream comparison, and applied merges (§9–10).
- `docs/releases/1.1.9.md` (this file) — detailed change notes for the upstream-sync portion.
